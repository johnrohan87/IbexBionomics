        ...
        <Container>
          <div className="flex h100 alignCenter">
            <ContentArea minWidth="25vw" minHeight="60vh" backgroundImage={`url(${leafbg})`} >
              <p className="centerXandY whiteText cursorPointer" onClick={()=> currentPDF === Agriculture_Catalogue ? setCurrentPDF('none'): setCurrentPDF(Agriculture_Catalogue)}>
                    <b>
                    Agriculture
                    </b>
            ...
            <ContentArea minWidth="25vw" minHeight="60vh" backgroundImage={`url(${hpAquaculture})`}>
              <p className="centerXandY whiteText cursorPointer" onClick={()=> currentPDF === Aquaculture_Catalog ? setCurrentPDF('none'): setCurrentPDF(Aquaculture_Catalog)}>
                <b>
                Aquaculture
                </b>
        ...
        <Container>
          <div className="flex h100 alignCenter">
            <ContentArea minWidth="25vw" minHeight="60vh" backgroundImage={`url(${hpHydrocarbon})`}>
              <p className="centerXandY whiteText cursorPointer" onClick={()=> currentPDF === Hydrocarbon_Catalog ? setCurrentPDF('none'): setCurrentPDF(Hydrocarbon_Catalog)}>
                  <b>
            ...
            <ContentArea minWidth="25vw" minHeight="60vh" backgroundImage={`url(${MicroorganismsBG})`}>
                <p className="centerXandY whiteText cursorPointer" onClick={()=> currentPDF === Waste_Waters_Catalogue ? setCurrentPDF('none'): setCurrentPDF(Waste_Waters_Catalogue)}>
                  <b>
                  Environmental Remediation
                  <br/>
                  Waste Waters
        ...
        <Container>
          <div className="flex h100 alignCenter">
            <ContentArea minWidth="25vw" minHeight="60vh" backgroundImage={`url(${nu3zer})`} >
              <p className="centerXandY whiteText cursorPointer" onClick={()=> currentPDF === Nu3zer_Catalog ? setCurrentPDF('none'): setCurrentPDF(Nu3zer_Catalog)}>
                    <b>
                    Nu3zer
                    </b>
                {/*<a className="whiteText" href={Agriculture_Catalogue} download>
