...
// Banner section data
/* ------------------------------------ */
//import AgricultureCatalogue from 'common/assets/data/interior/Agriculture.Catalogue.pdf;'
...
export const S2ProductsData = {
  bg_url: "common/assets/image/interior/IbexImages/S2/LeafBG.jpg",
  title: "Agricultural Products",
  text:
    'IBEX Bionomics agricultural products are certified organic and provide biological and natural treatments that enhance the plant’s defenses, reduce the pathogen’s protection capacity, and enhance the growth and proliferation of beneficial microorganisms. All IBEX Bionomics agricultural products are fully biodegradable and harmless to the environment.'
};
